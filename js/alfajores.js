...
const productosPrecios = [
    ...
    },
    {
      ...
      precio: "$1200",
      desc: "Alfajor negro bañado con chocolate semiamargo, relleno con mucho dulce de leche. La característica principal de este alfajor esta en la galletita donde tiene una delicada cantidad de cacao amargo.<br>Peso neto 70grs."
    },
    {
      nombre: "Chocolate Blanco",
      precio: "$1200",
      desc: "Riquísimo alfajor, con un excelente baño de chocolate blanco con dos galletita con un especial sabor a vainilla relleno con dulce de leche.<br>Peso neto 70grs."
    },
    {
    ...
    },
    {
      nombre: "Avena",
      precio: "$1200", 
      desc: "Deliciosooooooo!!!!! Cuando pruebes éste alfajor será un antes y un después!!! Seguramente lo vas a recomendar. Bañado con chocolate semiamargo y relleno con mucho dulce de leche. La avena en su interior lo hace, más saludable y le aporta un crocantito que lo hace especial!!!!<br>Peso neto 70grs."
    },
    {
      nombre: "Avena Nevada", 
      precio: "$1200", 

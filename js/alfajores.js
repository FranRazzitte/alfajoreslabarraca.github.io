...
const productosPrecios = [
    ...
    {nombre: "Caja por 6 alfajores", precio: "$7000", desc: "Podes elegir los siguientes sabores:<br>Chocolate Suave, Blanco, Leche.<br>Avena, Avena Nevada, Avena Frutal.<br>Maicena, Maicena Bañada Negro o Blanco.<br>Dulce de Leche Merengue.<br>Membrillo Merengue.<br>Membrillo Negro o Blanco.<br>Integral.<br><br>Opcional: Chocolate Intenso y Frutos Rojos adicional por unidad."},
    {nombre: "Caja por 12 alfajores", precio: "$14000", desc: "Podes elegir los siguientes sabores:<br>Chocolate Suave, Blanco, Leche.<br>Avena, Avena Nevada, Avena Frutal.<br>Maicena, Maicena Bañada Negro o Blanco.<br>Dulce de Leche Merengue.<br>Membrillo Merengue.<br>Membrillo Negro o Blanco.<br>Integral.<br><br>Opcional: Chocolate Intenso y Frutos Rojos adicional por unidad."},
]

...
footerContent.innerHTML = `
    <div class="text-lg-start bg-light">
		...
		<div class="footercopy text-center">
			<div>
				<p data-lang="lb-text-footer-section:slogan" style="font-size: 14px; margin: 0%;"><i class='bx bxs-heart eslogan' style="color: red;"></i> Los mejores momentos de la vida, se disfrutan comiendo, un buen alfajor <i class='bx bxs-heart eslogan' style="color: red;"></i></p>
				<p data-lang="lb-text-footer-section:copyright" style="font-size: 12px; margin: 0%;">© 2021 - 2025, Alfajores La Barraca. Todos los derechos reservados. Buenos Aires, Argentina.</p>
			</div>
			<div class="justify-content-center">
				<p data-lang="lb-innerHTML-footer-section:creator" style="font-size: 14px; margin: 0%;">Creado por <a href="https://www.instagram.com/franrazzitte/" class="text-reset">@franrazzitte</a></p>
			</div>
		</div>
	</div>
`;

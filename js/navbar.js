...
navbarContent.innerHTML = `
    <div class="navbar navbar-expand-lg navbar-collapse collapse shadow-sm p-0" id="evento-banner" style="padding:0 3% 0 3%; background-color:var(--clr-background-lb) !important;">
    ...
    <div class="navbar navbar-expand-lg shadow-sm py-2 bg-white" style="padding: 0 3% 0 3%">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarMain">
                <form class="d-flex mx-auto my-2 ms-0" role="search" style="width: 50%; position: relative;" id="formSearch">
                    <input class="form-control rounded-end-0" type="search" placeholder="Buscar..." id="buscar" aria-label="Buscar" lang="lb-placeholder-navbar-section:search">
                ...
                <ul class="navbar-nav ms-2 mb-2 mb-lg-0 justify-content-center">
                  <li class="nav-item me-3 d-none link">
    ...
    <div class="navbar navbar-expand-lg nav-desktop-list shadow-sm py-2 border" style="padding: 0 3% 0 3%; background-color: var(--bs-body-bg) !important; border-bottom-width: 0 !important; border-left-width: 0 !important; border-right-width: 0 !important;">

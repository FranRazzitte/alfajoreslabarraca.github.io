        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarMain">
                <form class="d-flex mx-auto my-2" role="search" style="width: 50%; position: relative;" id="formSearch">
                    <input class="form-control me-2" type="search" placeholder="Buscar..." id="buscar" aria-label="Buscar" lang="lb-placeholder-navbar-section:search">
                ...
                <ul class="navbar-nav ms-2 mb-2 mb-lg-0 justify-content-center">
                    <li class="nav-item me-3">
                        <a class="nav-link" href="/nosotros">
                            ...
                            <span style="display: none;" lang="lb-text-navbar-section:about-us">Nosotros</span>
                        </a>
                    </li>
                    <li class="nav-item me-3">

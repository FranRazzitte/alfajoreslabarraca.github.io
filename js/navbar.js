        ...
        <div class="row">
            ...
            <div class="col-md-4 justify-content-left justify-content-md-start mb-md-0 navDiv2" id="navDiv2">
                <form class="input-group w-100 my-auto d-none d-sm-flex" id="formSearch">
                    <input
                        data-lang="lb-placeholder-navbar-section:search"
                        autocomplete="off"
                        id="buscar"
                ...
                <div class="d-flex justify-content-center align-items-center">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" id="dropdownMenu">
                            <li><button data-lang="lb-btn-navbar-section:light-mode" class="dropdown-item" id="light-mode">Modo Claro</button></li>
                            <li><button data-lang="lb-btn-navbar-section:night-mode" class="dropdown-item" id="dark-mode">Modo Oscuro</button></li>
                            <li><button data-lang="lb-btn-navbar-section:default" class="dropdown-item selected" id="auto-mode">Igualar al Sistema</button></li>
                        </ul>
                    </div>
                </div>
            </div>

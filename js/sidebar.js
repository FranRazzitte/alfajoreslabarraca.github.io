...
sidebar.innerHTML = `
    <div>
        ...
        <div style="margin-bottom: 25px">
            <div class="col-md-4 navBusquedaMovil" id="navBusquedaMovil">
                <form class="d-flex h-100 input-group w-auto my-auto mb-3 mb-md-0 form-control rounded" style="margin-right: 10px; margin-left: 10px; border: var(--bs-border-width) solid var(--bs-border-color);" id="formSearchMovil">
...
const menuBuscar = document.getElementById('navBusquedaMovil');
